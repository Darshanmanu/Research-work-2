...
File_Desc_Reader=open("D:\\research 2\\Data\\V1 Dataset\\V1 FInal\\NumericTrainPassage.txt",encoding='utf-8').read()
File_Desc_Reader2=open("D:\\research 2\\Data\\V1 Dataset\\V1 FInal\\NumericTrainUnPassage.txt",encoding='utf-8').read()
