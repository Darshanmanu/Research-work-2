...
File_Desc_Reader=open("D:\\research 2\\Data\\V1 Dataset\\V1 FInal\\LocationTrainPassage.txt",encoding='utf-8').read()
File_Desc_Reader2=open("D:\\research 2\\Data\\V1 Dataset\\V1 FInal\\LocationTrainUnPassage.txt",encoding='utf-8').read()
